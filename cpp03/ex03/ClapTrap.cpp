...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/18 05:14:26 by aelbouaa          #+#    #+#             */
/*   Updated: 2024/01/18 08:04:36 by aelbouaa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap( std::string nm) : name(nm), HitPoint(100), EnergyPoint(50), AttackDamage(30)
{
